...
class RMUZoneRenderer {
    static update(token) {
        ...
        const drawConfig = {
            front: parseInt(
                game.settings
                    .get(MODULE_ID, SETTINGS.COLOR_FRONT)
                    .replace("#", ""),
                16,
            ),
            flank: parseInt(
                game.settings
                    .get(MODULE_ID, SETTINGS.COLOR_FLANK)
                    .replace("#", ""),
                16,
            ),
            rear: parseInt(
                game.settings
                    .get(MODULE_ID, SETTINGS.COLOR_REAR)
                    .replace("#", ""),
                16,
            ),
            spoke: parseInt(
                game.settings
                    .get(MODULE_ID, SETTINGS.COLOR_SPOKE)
                    .replace("#", ""),
                16,
            ),
            facing: parseInt(
                game.settings
                    .get(MODULE_ID, SETTINGS.COLOR_FACING)
                    .replace("#", ""),
                16,
            ),
        ...
        const rawBodyZone =
            Number(token.actor.system.appearance?._combatZone) || 0;
